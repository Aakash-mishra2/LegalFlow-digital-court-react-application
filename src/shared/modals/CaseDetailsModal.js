...
const CaseDetailsModal = ({ item, show, closeModal }) => {
    return (
        ...
        >
            ...
            <br /><br />
            <span className="font-medium text-md">Hearing Date: <p className="font-extralight text-sm inline">{item?.nextHearing?.date}</p></span>
            <br />
            <span className="font-medium text-md">Case Timings: <p className="font-extralight text-sm inline">{item?.nextHearing?.timings}</p></span>
            <br />
            <span className="font-medium text-md">Case Status: <p className="font-extralight text-sm inline">{item?.status}</p></span>
        </CommonModal>
    )
};
